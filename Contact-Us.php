...
<link rel="stylesheet" href="css/Home.css" media="screen">
  ...
  <?php include_once "header.php"; ?>
    ...
    <section class="u-align-center  " id="sec-3eeb">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1"></h1>
        <div class="u-form u-form-1">
          <form action="contact_action.php" method="post"  style="padding: 50px;">
            ...
            <div class="u-align-center u-form-group u-form-submit">
              ...
              <input type="submit" value="Contact US" class="u-active-custom-color-2 u-border-2 u-border-black u-btn u-btn-round u-btn-submit u-button-style u-custom-color-2 u-hover-black u-radius-15 u-text-black u-text-hover-white u-btn-1" name="btn_submit">
            </div>
